function [] = runWoidlinoParamSamplesPosteriorMeanWithUndulations(makeMovie)
...
param.k_theta = 0;
param.omega_m = 2*pi*0.6; % angular frequency of oscillation of movement direction, default 0.6 Hz
param.theta_0 = pi/4; % amplitude of oscillation of movement direction, default pi/4
param.deltaPhase = 0.24*49/M; % for phase shift in undulations and initial positions, default 0.24 - adjust for <49 nodes
...
for repCtr = 1:numReps
    filename = ['wlM' num2str(M) '_N_' num2str(N) '_L_' num2str(L(1)) ...
        ...
        '_postiMean_run' num2str(repCtr) '_undulating'];
