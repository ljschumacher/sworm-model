function [] = runWoidlinoParamSamplesPosteriorMeanWithSweeping(r_feed,makeMovie)
...
for repCtr = 1:numReps
    filename = ['wlM' num2str(M) '_N_' num2str(N) '_L_' num2str(L(1)) ...
        ...
        '_postiMean_run' num2str(repCtr) '_sweeping_feedrate_' num2str(r_feed)];
    ...
    if ~exist([filepath filename '.mat'],'file')
        ...
        save([filepath filename '.mat'],'xyarray','T','N','M','L','param','currentState','food')
