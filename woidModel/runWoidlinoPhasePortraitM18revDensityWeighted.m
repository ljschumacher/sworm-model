function [] = runWoidlinoPhasePortraitM18revDensityWeighted(paramCtr)
...
paramAll.slowingMode = 'stochastic_weighted';
paramAll.k_dwell = 0.0036;
paramAll.k_undwell = 1.1;
% -- reversal parameters --
paramAll.reversalMode = 'density_weighted';
...
dkdN_dwell_values = 0:0.1:0.5;
dkdN_undwell_values = 0:0.1:1.2;
drdN_rev_values = 0:0.1:0.5;
