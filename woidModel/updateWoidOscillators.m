function thetaNow = updateWoidOscillators(thetaPrev, theta_0, ...
    omega, t, phaseOffset, reversals)
...
thetaNow = thetaPrev + theta_0*Omega.*cos(Omega*(t-1/2) + phaseOffset) ...
         + pi*diff(reversals,1,2); % 180 degree turn when reversal starts or ends
