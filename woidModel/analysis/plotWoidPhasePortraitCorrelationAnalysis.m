...
%                             framesAnalyzed = burnIn+1:maxNumFrames;
    ...
    filename = ['figures/woidPhasePortraitRadialdistribution_N_' num2str(thisFile.N) '_L_' num2str(thisFile.L(1)) ...
        ...%'_noUndulations'... % '_noVolExcl'
        '_speed_'...
    ...
    filename = ['figures/woidPhasePortraitSpeedvDistance_N_' num2str(thisFile.N) '_L_' num2str(thisFile.L(1)) ...
        ...%'_noUndulations'... % '_noVolExcl'
    ...
    filename = ['figures/woidPhasePortraitDirxcorr_N_' num2str(thisFile.N) '_L_' num2str(thisFile.L(1)) ...
        ...%'_noUndulations'... % '_noVolExcl'
        '_speed_' num2str(speed,'%1.0e') '_slowing' '_gradual'...
        ...%'_noInClusterRev' ...
        '.eps'];
    ...
    filename = ['figures/woidPhasePortraitVelxcorr_N_' num2str(thisFile.N) '_L_' num2str(thisFile.L(1)) ...
        ...%'_noUndulations'... % '_noVolExcl'
        '_speed_' num2str(speed,'%1.0e') '_slowing' '_gradual'...
        ...%'_noInClusterRev' ...
        '.eps'];
