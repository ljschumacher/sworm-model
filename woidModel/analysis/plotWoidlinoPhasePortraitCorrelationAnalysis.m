function [] = plotWoidlinoPhasePortraitCorrelationAnalysis(Nvalue,Lvalue,attractionStrength)
...
%                             framesAnalyzed = burnIn+1:maxNumFrames;
    ...
    filename = ['figures/woidlinoPhasePortraitRadialdistribution_N_' num2str(thisFile.N) '_L_' num2str(thisFile.L(1)) ...%'_noUndulations'...
        '_speed_'...
