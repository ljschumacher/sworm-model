...
load(['paramSamples_nSamples100000_nParam4_M_' num2str(M) '_noVolExcl' ...
    '_angleNoise_' num2str(param.angleNoise) '_k_theta_' num2str(param.k_theta)...
    '_slowing_' param.slowingMode '_dwell_' num2str(param.k_dwell) '_' num2str(param.k_undwell)...
    '_rev' param.reversalMode '_haptotaxis_' num2str(param.haptotaxisMode)...
...
% filepath = '/exports/eddie/scratch/lschuma2/woidlinos/PRW_4D_r1/N2/';
filepath = 'results/woidlinos/paramSamples/PRW_4D_taxis_weighted_additive_r1/N2/';
