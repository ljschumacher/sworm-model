...
reversalMode = 'density_weighted';
drdN_rev_values = 0:0.05:0.45;

speed = [0.33];
slowspeed = 0.018;
slowingMode = 'stochastic_weighted';
k_dwell = 0.0036;
k_undwell = 1.1;
dkdN_dwell_values = 0:0.05:0.45;
dkdN_roam_values = 0:0.05:0.45;
angleNoise = 0.04;
k_theta = 0;
% f_hapt = 0.5;
...
h = slice(dkdN_dwell_values,drdN_rev_values,dkdN_roam_values,BiggestComponentSize,[0.45],[0.05 0],[ 0]);
hold on
