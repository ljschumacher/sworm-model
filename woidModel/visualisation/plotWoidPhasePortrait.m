...
for speed = speeds
    ...
    for slowspeed = slowspeeds
        for revRateClusterEdge = revRatesClusterEdge
            filename = ['../results/woids/woids_N_' num2str(Nval) '_L_' num2str(Lval) ...%'_noUndulations'...
    ...
    filename = ['../figures/woids/woidPhasePortrait_N_' num2str(Nval) '_L_' num2str(Lval) ...%'_noUndulations'...
