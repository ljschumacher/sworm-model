...
figure
% draw head zone
patch(xyarray(:,headNodes,1,1) + 3*rc*cos(angles),...
    xyarray(:,headNodes,2,1) + 3*rc*sin(angles),...
    [0.2 0.8 0.2],'EdgeColor','None')
axis equal, hold on
% draw tail zone
patch(xyarray(:,tailNodes,1,1) + 3*rc*cos(angles),...
    xyarray(:,tailNodes,2,1) + 3*rc*sin(angles),...
