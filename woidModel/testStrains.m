...
%     ...%'_kl' num2str(k_l)...
%     ])
% animateWoidTrajectories(xyarray,['tests/DA609_periodic_lennardjones' num2str(eps_LJ,'%1.0e')...
...
xyarray = runWoids(T,40,M,L,'bc','periodic','dT',dT,'saveEvery',saveEvery,...
    ...
    'Ris',0,'v0',v0,'vs',v0... % no slowing down
...
animateWoidTrajectories(xyarray,['tests/dummies_periodic_lennardjones' num2str(eps_LJ,'%1.0e')...
    '_kl' num2str(k_l)...
    '_v' num2str(v0) ...
    ],L);
